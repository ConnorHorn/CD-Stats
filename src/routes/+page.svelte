						...
						<Accordion>
							<AccordionItem>
								...
								<svelte:fragment slot="content"
									>A website that summarizes statistics from a given users account on
									ChiefDelphi.com. It is for entertainment value only.</svelte:fragment
								>
							</AccordionItem>
							<AccordionItem>
							...
							<AccordionItem>
								...
								<svelte:fragment slot="content"
									...
									All analysis is done on your computer, so your information stays private. For
									extra caution, you can remove post content or personal details from the data
									files. The site doesn't use your post text, email, etc. You can check this by
									observing no data exchange in the network section of inspect element after the
									site loads, or by using the site in airplane mode.</svelte:fragment
								>
							</AccordionItem>
							<!-- ... -->
						</Accordion>
