...
<div class="card grid-item grid-item--width200 p-5 w-full sm:w-fit h-fit " in:fly={{ y: Math.random()*300-150, x:Math.random()*300-150, duration: 750 }} >
    <MobilePercent visitsData={visitsData}/>
</div>
    ...
    <div class="card grid-item grid-item--width600 p-1 w-full sm:w-fit h-fit " in:fly={{ y: Math.random()*300-150, x:Math.random()*300-150, duration: 750 }} >
    ...
    <div class="card grid-item grid-item--width300 p-1 w-full sm:w-fit h-fit " in:fly={{ y: Math.random()*300-150, x:Math.random()*300-150, duration: 750 }} >
    ...
    {#if archiveData.postCount>0}
        <div class="card grid-item grid-item--width200 p-5 w-full sm:w-fit h-fit " in:fly={{ y: Math.random()*300-150, x:Math.random()*300-150, duration: 750 }} >
            <LikesPerPost value={Math.round(parseInt(archiveData.likeCount)/parseInt(archiveData.postCount)*10)/10}/>
        </div>
    {/if}
