...
<div class="card h-fit w-full p-5 text-2xl sm:w-fit flex flex-col items-center justify-center">
    <div class="text-center" bind:this={typeItElement}></div>

    {#if displayImage}
        <img src="images/{imageName}.png" alt="Who you are" in:fade={{ duration: 500 }} class="max-w-xs mt-4">
    {/if}
</div>
